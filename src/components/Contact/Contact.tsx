	...
	return (
		<div className="contact-wrapper">
			...
			<section className="section-container">
				...
				<p className="section-container__text">Tanto si estás buscando una desarrolladora frontend para una nueva aventura como si crees que podemos colaborar y compartir
